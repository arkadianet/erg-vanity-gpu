# Successor notice for ergo-vanitygen-rust

This repository (`erg-vanity-gpu`) is the surviving codebase.
...
Keep developing here. Rename this GitHub repo (e.g. to `ergo-vanity`) only after a green release if a cleaner public name is worth the URL change. Do not fork the work into a third empty repo unless you want a clean star/issue history.
